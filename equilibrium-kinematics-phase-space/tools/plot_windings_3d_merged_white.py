...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stiff-size", type=float, default=0.5)
    parser.add_argument("--stiff-opacity", type=float, default=0.55)
    parser.add_argument("--conv-size", type=float, default=1.0)
...
def build_figure(data: pd.DataFrame, metric: str, args: argparse.Namespace):
    ...
    figure.update_layout(
        ...
        scene={
            ...
            "aspectmode": "auto",
            "bgcolor": "#ffffff",
            "xaxis": {"backgroundcolor": "#ffffff", "gridcolor": "#d9e0e8", "zerolinecolor": "#aeb8c4"},
            "yaxis": {"backgroundcolor": "#ffffff", "gridcolor": "#d9e0e8", "zerolinecolor": "#aeb8c4"},
            "zaxis": {"backgroundcolor": "#ffffff", "gridcolor": "#d9e0e8", "zerolinecolor": "#aeb8c4"},
...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .plot-card:hover {{ border-color: #7b96bd; }}
    .plot-card.main {{
      grid-column: 1;
      grid-row: 1 / 4;
      border-color: #6f91c7;
    ...
    .main .badge::after {{ content: " · principale"; color: #3569a8; }}
